...
[animation]
s0_open_effects = animation:Sidekick;animation:Fade;animation:None;
s0_open_durations = 120;80;50;
s0_open_matches = ((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver);(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);;
s0_open_options = ;;;
s0_open_random_effects = 
s0_close_effects = animation:Glide 2;animation:Fade;animation:Fade;animation:Dream;
s0_close_durations = 120;150;50;100;
s0_close_matches = ((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver) & !(name=gnome-screenshot);((Combo | Dialog | ModalDialog | Normal) & !(class=\\.exe$));(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);(type=Menu | PopupMenu | DropdownMenu);
s0_close_options = ;;;;
...
s0_speed = 1.500000
s0_timestep = 1.200000
s0_top_color = #f62626ff
s0_bottom_color = #f60000ff
s0_skydome = false
s0_skydome_image = /home/zlsh80826/picture/7028040701_cf8165c547_k.jpg
...
s0_put_pointer_key = <Shift><Control>z
...
[decor]
s0_active_shadow_radius = 12.300000
s0_active_shadow_opacity = 0.010000
s0_active_shadow_color = #dd373700
...
s0_shadow_match = (any) & !(class=Conky)

[core]
s0_active_plugins = core;crashhandler;composite;opengl;compiztoolbox;decor;grid;place;imgpng;staticswitcher;mousepoll;imgjpeg;regex;move;animation;resize;fadedesktop;blur;put;wobbly;animationaddon;cube;rotate;scale;cubeaddon;wizard;expo;freewins;
...
s0_top_images = /home/zlsh80826/picture/7028040701_cf8165c547_k.jpg;
s0_bottom_images = /home/zlsh80826/picture/Sandblast-Plain-II.jpg;
